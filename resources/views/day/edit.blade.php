    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="/day/{{$day->id}}">
                        @csrf
                        @method("put")
                        <div class="row mb-3">              
                            <div class="col-md-12 mb-3">
                                <div class="form-floating">
                                    <input class="form-control @error('period') is-invalid @enderror" id="inputYearTwo" type="text" name="name" value="@if($errors->any()){{ old("name")}}@else{{$day->name}}@endif">
