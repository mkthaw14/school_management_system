                ...
                <div class="card-body">
                    <form method="POST" action="/timetable/{{$timetable->id}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('') is-invalid @enderror" name="" id="grade">
                                        ...
                                        @foreach ($grades as $v)
                                            <option value="{{$v->id}}" @if ($selected_section->grade->id == $v->id)
                                                {{"selected"}}
                                            @endif> {{$v->name}} - {{$v->academic_year->yearOne}}</option> 
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('teacher_id') is-invalid @enderror" name="teacher_id"  id="teacher">
                                        ...
                                        @foreach ($teachers as $v)
                                            <option value="{{$v->id}}" @if ($selected_teacher->id == $v->id)
                                                {{"selected"}}
                                            @endif> {{$v->name}} </option> 
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('subject_id') is-invalid @enderror" name="subject_id" id="subject">
                                        <option selected>Choose...</option>
                                        @foreach ($subjects as $v)
                                            <option value="{{$v->id}}" @if ($selected_subject->id == $v->id)
                                                {{"selected"}}
                                            @endif> {{$v->name}} </option> 
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('section_id') is-invalid @enderror" name="section_id" id="section">
                                        <option selected>Choose...</option>
                                        @foreach ($selected_section->grade->sections as $v)
                                            <option value="{{$v->id}}" @if ($selected_section->id == $v->id)
                                                {{"selected"}}
                                            @endif> {{$v->name}} </option> 
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('day_id') is-invalid @enderror" name="day_id">
                                        <option selected>Choose...</option>
                                        @foreach ($days as $v)
                                            <option value="{{$v->id}}" @if ($selected_day->id == $v->id)
                                            {{"selected"}}
                                            @endif> {{$v->name}}</option> 
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 ">
                                    <select class="form-control @error('time_id') is-invalid @enderror" name="time_id">
                                        <option selected>Choose...</option>
                                        @foreach ($times as $v)
                                            <option value="{{$v->id}}" @if ($selected_time->id == $v->id)
                                                {{"selected"}}                                                
                                            @endif> {{$v->period}}</option> 
                                        @endforeach
                                    </select>
